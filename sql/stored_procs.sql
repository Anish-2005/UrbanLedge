-- Stored procedures, triggers and views for OPTMS (MySQL)
...
BEGIN
  ...
  -- pick the active slab for that property type and area
...
-- View: outstanding payments by ward
CREATE VIEW vw_outstanding_by_ward AS
